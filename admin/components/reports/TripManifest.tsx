    ...
    <div className={styles['manifest']}>
      ...
      <section className={styles['main']}>
        <p>
          ...
          <span style={underlined}>
            {dayjs(manifest.departureDate).format('Do [day of] MMMM[,] YYYY')}
          </span>
          &nbsp;for the Port of&nbsp;
        ...
        <p>
          ...
          Port of <span style={underlined}>{manifest.srcPortName}</span> ) S.S.
        </p>
      </section>
      <section className={styles['footer']}>
        <p>
          ...
          <span style={underlined}>{manifest.shipName}</span>, do solemnly swear
          that the foregoing is a full and complete manifest of all passengers
          taken on board said vessel on its present voyage, and statements
        ...
        <div className={styles['signature']} style={{ gap: '8px' }}>
          <BlankUnderline width='400px' />
          <p style={{ maxWidth: '350px', lineHeight: '1.2' }}>
            Empowered to Administer oath under the provisions of Section 1147 of
